...
[![Build Status](https://github.com/RND-SOFT/quickfix/workflows/CI/badge.svg)](https://github.com/RND-SOFT/quickfix/actions) [![GoDoc](https://godoc.org/github.com/RND-SOFT/quickfix?status.png)](https://godoc.org/github.com/RND-SOFT/quickfix) [![Go Report Card](https://goreportcard.com/badge/github.com/RND-SOFT/quickfix)](https://goreportcard.com/report/github.com/RND-SOFT/quickfix)

Open Source [FIX Protocol](http://www.fixprotocol.org/) library implemented in Go

### Looking for help with `MessageStore` syntax changes?
See v0.9.0 release notes [here](https://github.com/RND-SOFT/quickfix/releases/tag/v0.9.0)
...
<ul>
  <li>100% free and open source with a liberal <a href="https://github.com/RND-SOFT/quickfix/blob/master/LICENSE.txt">license</a></li>
...
```
import "github.com/RND-SOFT/quickfix"
```
...
```sh
go get -u github.com/RND-SOFT/quickfix
```

## Getting Started

* [QuickFIX User Manual](https://quickfixengine.org/go/documentation/)
* [Go API Documentation](https://godoc.org/github.com/RND-SOFT/quickfix)
...
<p>Our <a href="https://github.com/RND-SOFT/quickfix/discussions/categories/q-a">Github Discussions Board</a> is free, public, and easily searchable. It’s the preferred method of user support from the QuickFIX/Go team.
...
<p><a href="https://github.com/RND-SOFT/quickfix/issues">GitHub Issues</a></p>
...
This software is available under the QuickFIX Software License. Please see the [LICENSE.txt](https://github.com/RND-SOFT/quickfix/blob/main/LICENSE.txt) for the terms specified by the QuickFIX Software License.
